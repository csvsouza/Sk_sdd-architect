---
schema_version: '1.0'
project_id: python-oracle
project_name: EXEMPLO FICTÍCIO python-oracle
...
- path: entrada.md
  revision: '1.0'
  sha256: c6e4d1a1db720bdb2e5164445611f6c682e45fe08a065d25a7ecee8904cd3edb
- path: projeto-regras.md
  revision: '1.0'
  sha256: 15e34d5884f3f9ebf0c4b609a1e1ab5818d9d5b4a8593ea82899e95b2b8dfbd1
- path: spec.md
  revision: '1.0'
  sha256: a5a485b04364c31ca79fcf3c736d0b8c98fe976561502169b255278288d77644
- path: architecture.md
  revision: '1.0'
  sha256: f2acd7a112f683bb62e63c0b892d097bbe1605fce95dd27bff7f6f45b026cc6f
- path: tasks.md
  revision: '1.0'
  sha256: bc6f6c69fab08ca21afcfb99a3aa241e0508df5498d6becd00049f499cb537ae
- path: testing.md
  revision: '1.0'
  sha256: c98a246f5493f4ee6437785075b1c3fc0eeaf00cb9ad08ca58e798a16ac614e1
- path: database.md
  revision: '1.0'
  sha256: d7a017158aedbb178c0afabceb2e704e10a36813ba8689cd5e15cea612f615a2
- path: integrations.md
  revision: '1.0'
  sha256: 24c76fe5b6e5782d685fac2291e543e923acfdb89f68405b3f60ffb7b566baae
- path: operations.md
  revision: '1.0'
  sha256: b449390f415499238ee11ec3b7c6cc3e2c73c5cf6df11fa97b049e9134a0f50c
...
Projeto python-oracle, fictício. Documento 1.0, formato 1.0, responsável pendente. Fontes/revisões no YAML.
...
FUN-01 — Importar lote. Origem: [REQ-01](spec.md); entradas/saídas e dependências ali descritas. Estado planejado.

## Visão de engenharia

Python e Oracle/PLSQL confirmados sem versões. Dois componentes: leitor/validador Python e persistência Oracle. Contrato e chave de unicidade precisam confirmação antes de implementação. Transação proposta por lote; COMMIT sob responsabilidade do coordenador a confirmar, sem criar package real. Fonte: [spec](spec.md).

## Dados e conceitos

Lote, registro e checkpoint. Retenção pendente; chave do lote a confirmar.
...
```mermaid
flowchart TD
  A([Inicio]) --> B["Validar lote e chave"]
  B --> C{"Permissao e dados validos?"}
  C -->|Nao| E["Interromper e registrar pendencia"]
  C -->|Sim| D["Persistir e registrar checkpoint"]
  D --> F([Fim])
```

Descrição textual: iniciar, validar lote e chave, verificar permissão e dados; inválidos interrompem com pendência, válidos seguem para persistir e registrar checkpoint e fim.
