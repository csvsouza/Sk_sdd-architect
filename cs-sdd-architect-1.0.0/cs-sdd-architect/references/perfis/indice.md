...
Recursos dependentes de versão exigem consulta à documentação oficial daquela versão e registro de URL, data e decisão sustentada. Não é necessário pesquisar recursos que não serão prescritos. As referências abaixo são roteiros de especificação, não catálogo de versões.
